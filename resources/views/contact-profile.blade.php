                        ...
                        <div class="flex-shrink-0">
                            <div class="avatar-xxl me-3">
                                <img class="img-fluid rounded-circle d-block img-thumbnail"
                                    src="@if ($users->avatar != '') {{ URL::asset($users->avatar) }}@else
                                    {{ URL::asset('assets/images/users/avatar-1.jpg') }} @endif"
                                    alt="Header Avatar">
                                {{-- <img src="@if ($users->avatar != ''){{ URL::asset('images/'. $users->avatar) }}@else{{ URL::asset('assets/images/users/avatar-1.png') }}@endif" alt="profile-image" class="img-fluid rounded-circle d-block img-thumbnail"> --}}
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="update-profile">
                        @csrf
                        <input type="hidden" value="{{ $users->id }}" id="data_id">
                        <div class="mb-3">
                            <label for="useremail" class="form-label">Email</label>
                            <input type="email" class="form-control @error('email') is-invalid @enderror"
                                id="useremail" value="{{ $users->email }}" name="email"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                value="{{ $users->name }}" id="username" name="name" autofocus
                        ...
                        <div class="mb-3">
                            ...
                            <div class="text-start mt-2">
                                <img src="@if ($users->avatar != '') {{ URL::asset( $users->avatar) }}@else{{ URL::asset('assets/images/users/avatar-1.png') }} @endif"
                        ...
                        <div class="mt-3 d-grid">
                            <button class="btn btn-primary waves-effect waves-light UpdateProfile"
                                data-id="{{ $users->id }}" type="submit">Update</button>
                        </div>
                    </form>
                </div>
            </div><!-- /.modal-content -->
