                            ...
                            <tbody>
                                @foreach ($orders as $item)
                                    <tr data-id="{{ $item->id }}">
                                        ...
                                        <td data-field="name">{{ $item->qty }}</td>
                                        <td data-field="manufacturer">{{ $item->totalPrice }}</td>
                                        <td data-field="manufacturer">{{ $item->status}}</td>
                                        <td data-field="manufacturer">{{ $item->created_at }}</td>
                                        {{-- <td>
