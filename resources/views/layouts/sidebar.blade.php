                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                ...
                                <li><a href="javascript: void(0);" data-key="t-level-2-2">@lang('translation.Products')</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow"
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="javascript: void(0);" data-key="t-level-2-1">@lang('translation.all_orders')</a></li>
                                <li><a href="javascript: void(0);" data-key="t-level-2-1">@lang('translation.cancelled_orders')</a></li>
                                <li><a href="javascript: void(0);" data-key="t-level-2-2">@lang('translation.pending_orders')</a></li>
                                <li><a href="javascript: void(0);" data-key="t-level-2-2">@lang('translation.completed_orders')</a></li>
                            </ul>
                        </li>
                        <li>
