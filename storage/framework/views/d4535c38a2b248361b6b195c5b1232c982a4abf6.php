                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-8">
                        <div class="text-sm-end">
                            <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"><i class="mdi mdi-plus me-1"></i> New Customer</button>
                        </div>
                    </div><!-- end col-->
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/laravel/zoidinc admin/resources/views/ecommerce-customers.blade.php ENDPATH**/ ?>