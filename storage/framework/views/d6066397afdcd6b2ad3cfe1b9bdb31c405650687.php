                ...
                <?php if($type == 'view'): ?>
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('product.update')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="alert alert-primary"> <?php echo e($product->type ?? 'Product'); ?> </div>
                            <input type="hidden" name="id" value="<?php echo e($product->id); ?>">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label for="pTitle">Product Name</label>
                                        <input id="pTitle" value="<?php echo e($product->pTitle); ?>" name="pTitle" type="text"
                                            class="form-control" placeholder="Product Name" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="manufacturername">Manufacturer Name</label>
                                        <input id="manu_name" value="<?php echo e($product->manu_name); ?>" name="manu_name"
                                            type="text" class="form-control" placeholder="Manufacturer Name" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="manu_brand">Manufacturer Brand</label>
                                        <input id="manu_brand" value="<?php echo e($product->manu_brans); ?>" name="manu_brand"
                                            type="text" class="form-control" placeholder="Manufacturer Brand">
                                    </div>
                                    <img src="<?php echo e($product->pImage); ?>" alt="" height="100px">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <input id="price" name="pOldPrice" value="<?php echo e($product->pOldPrice); ?>"
                                                    type="text" class="form-control" placeholder="Old Price">
                                            </div>
                                            <div class="col-sm-6">
                                                <label for="price">Selling Price</label>
                                                <input id="price" name="pSellingPrice"
                                                    value="<?php echo e($product->pSellingPrice); ?> " type="text"
                                ...
                                <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <select class="form-control select2" name="pCategory" required>
                                                    <option value="<?php echo e($product->pCategory); ?>"> <?php echo e($product->pCategory); ?>
                                    ...
                                    <div class="mb-3">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <input id="qty" name="qty" value="<?php echo e($product->qty); ?>"
                                                    type="number" class="form-control" placeholder="Quntity" required>
                                            </div>
                                            <div class="col-sm-6">
                                                <label class="control-label">Label</label>
                                                <select class="form-control select2" name="label" required>
                                                    <option value="<?php echo e($product->label); ?>"><?php echo e($product->label); ?></option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="shortDescription" name="shortDescription" rows="5"
                                            placeholder="Short Description"><?php echo e($product->shortDescription); ?></textarea>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zoidinc\vendor Dashboard\resources\views/Ecommerce/product-single.blade.php ENDPATH**/ ?>