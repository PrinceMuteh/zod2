        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                ...
                                <li><a href="javascript: void(0);" data-key="t-level-2-2"><?php echo app('translator')->get('translation.Products'); ?></a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow"
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="javascript: void(0);" data-key="t-level-2-1"><?php echo app('translator')->get('translation.all_orders'); ?></a></li>
                                <li><a href="javascript: void(0);" data-key="t-level-2-1"><?php echo app('translator')->get('translation.cancelled_orders'); ?></a></li>
                                <li><a href="javascript: void(0);" data-key="t-level-2-2"><?php echo app('translator')->get('translation.pending_orders'); ?></a></li>
                                <li><a href="javascript: void(0);" data-key="t-level-2-2"><?php echo app('translator')->get('translation.completed_orders'); ?></a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                ...
                                <li><a href="javascript: void(0);" data-key="t-level-2-1">All Brands</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="javascript: void(0);" data-key="t-inbox">Add Auction</a></li>
                        <li><a href="javascript: void(0);" data-key="t-read-email">All Auctions</a></li>
                        <li><a href="javascript: void(0);" data-key="t-read-email">Completed Auctions</a></li>
                        <li><a href="javascript: void(0);" data-key="t-read-email">Pending Auctions</a></li>
                        <li><a href="javascript: void(0);" data-key="t-read-email">Expire Auctions</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="javascript: void(0);" data-key="t-inbox">New Barter</a></li>
                        <li><a href="javascript: void(0);" data-key="t-read-email">All Barter</a></li>
                        <li><a href="javascript: void(0);" data-key="t-read-email">Completed Barter</a></li>
                        <li><a href="javascript: void(0);" data-key="t-read-email">Pending Barter</a></li>
                        <li><a href="javascript: void(0);" data-key="t-read-email">Expired Barter</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="auth-email-verification" data-key="t-email-verification"><?php echo app('translator')->get('translation.Email_verification'); ?></a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="extended-session-timeout" data-key="t-session-timeout"><?php echo app('translator')->get('translation.Session_Timeout'); ?></a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow"
                                data-key="t-level-1-2"><?php echo app('translator')->get('translation.Level_1.2'); ?></a>
                            <ul class="sub-menu" aria-expanded="true">
...
<!-- Left Sidebar End -->
<?php /**PATH /Applications/MAMP/htdocs/laravel/zoidinc admin/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>