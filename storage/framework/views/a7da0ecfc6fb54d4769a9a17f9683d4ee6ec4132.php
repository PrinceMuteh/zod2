                    ...
                    <div class="d-flex align-items-end mt-3 mt-sm-0">
                        <div class="flex-shrink-0">
                            <div class="avatar-xxl me-3">
                                <img class="img-fluid rounded-circle d-block img-thumbnail"
                                    src="<?php if($users->avatar != ''): ?> <?php echo e(URL::asset($users->avatar)); ?><?php else: ?>
                                    <?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?> <?php endif; ?>"
                                    alt="Header Avatar">
                        ...
                        <div class="card-body">
                            <div class="blog-post">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-1">
                                        <h5 class="font-size-15 text-truncate"><a href="#"
                                                class="text-dark">Michael Smith</a></h5>
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 50px;"><img
                                            src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>"
                                ...
                                <tr>
                                    <td><img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>"
                                            class="rounded-circle avatar-sm" alt=""></td>
                                    <td>
                                        <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                                    ...
                                    <td>
                                        <i class="mdi mdi-circle-medium font-size-18 text-warning align-middle me-1"></i>
                                        Buzy
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>"
                                            class="rounded-circle avatar-sm" alt=""></td>
                                    <td>
                                        <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <i class="mdi mdi-circle-medium font-size-18 text-secondary align-middle me-1"></i>
                                        Offline
                                    </td>
                                </tr>
                            </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="update-profile">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" value="<?php echo e($users->id); ?>" id="data_id">
                        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>"
                                id="useremail" value="<?php echo e($users->email); ?>" name="email"
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e($users->name); ?>" id="username" name="name" autofocus
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <div class="text-start mt-2">
                                <img src="<?php if($users->avatar != ''): ?> <?php echo e(URL::asset( $users->avatar)); ?><?php else: ?><?php echo e(URL::asset('assets/images/users/avatar-1.png')); ?> <?php endif; ?>"
                        ...
                        <div class="mt-3 d-grid">
                            <button class="btn btn-primary waves-effect waves-light UpdateProfile"
                                data-id="<?php echo e($users->id); ?>" type="submit">Update</button>
                        </div>
                    </form>
                </div>
            </div><!-- /.modal-content -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zoidinc\vendor Dashboard\resources\views/contact-profile.blade.php ENDPATH**/ ?>